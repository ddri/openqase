...
<Steps>
  ...
  <Step title="Gradient computation">
    The gradients of the cost function with respect to the parameters are computed using a quantum subroutine, such as the quantum finite difference method, the quantum back-propagation algorithm, or the parameter-shift rule. These subroutines can estimate the gradients more efficiently than classical methods, by exploiting the quantum parallelism and finite difference effects<sup><a href="#ref-4">4</a></sup>.
  </Step>
...
<div className="references-section">
  <div id="ref-1" className="reference-item">
      1. Rebentrost, P., Schuld, M., Petruccione, F., & Lloyd, S. (2016). Quantum gradient descent and Newton's method for constrained polynomial optimization. arXiv preprint arXiv:1612.01789.
  </div>
  ...
  <div id="ref-5" className="reference-item">
      5. [1] Kerenidis, I., & Prakash, A. (2017). Quantum gradient descent for non-convex functions. arXiv preprint arXiv:1712.04903. URL:https://arxiv.org/abs/1712.04903
  </div>
