...
QAOA has been experimentally demonstrated on various quantum computing platforms, including superconducting qubits and trapped ions[^6]. It has been applied to a range of optimization problems and has shown promising results in finding approximate solutions that are competitive with classical methods.
